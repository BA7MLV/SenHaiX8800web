        ...
        <div className="border-t border-line-subtle px-6 py-4 space-y-6">
          <div className="grid gap-6 xl:grid-cols-2">
            <div className="space-y-4">
              <h3 className="m-0 text-sm font-medium text-content-primary">BLE 参数</h3>
            ...
            <div className="space-y-4">
              <h3 className="m-0 text-sm font-medium text-content-primary">常用机身设置</h3>
              <div className="grid gap-4">
                <NumberField
                  label="静噪等级"
                  min={0}
                ...
                <div className="flex items-center justify-between gap-4 rounded-[4px] border border-line-subtle bg-surface-muted/50 px-4 py-3">
